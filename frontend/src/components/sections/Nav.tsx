  ...
  return (
    <>
      <nav id="nav" className="fixed top-0 left-0 right-0 z-50 py-3 px-5 sm:px-[clamp(1.5rem,5vw,4.5rem)] flex justify-between items-center bg-[#FAFAF7]/90 backdrop-blur-md border-b border-[#E0DCD2] transition-all duration-300">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 hidden lg:flex items-center gap-4 lg:gap-9">
          ...
          <a href="#fractional-cmo" className="text-sm font-medium text-black/50 relative transition-colors duration-200 hover:text-black after:absolute after:-bottom-0.5 after:left-0 after:right-full after:h-px after:bg-[#1C4A2E] after:transition-all after:duration-250 hover:after:right-0">Fractional CMO</a>
          ...
          <a href="#who-i-work-with" className="text-sm font-medium text-black/50 relative transition-colors duration-200 hover:text-black after:absolute after:-bottom-0.5 after:left-0 after:right-full after:h-px after:bg-[#1C4A2E] after:transition-all after:duration-250 hover:after:right-0">Who I work with</a>
        ...
        <a href="#book" className="items-center text-sm font-semibold text-white bg-[#1C4A2E] px-5.5 py-2.5 rounded-full tracking-[0.01em] transition-all duration-200 hover:bg-[#2A6840] hover:-translate-y-px hover:shadow-[0_6px_20px_rgba(28,74,46,.3)] hidden lg:inline-flex shrink-0">Book a call</a>

        {/* Mobile menu toggle */}
        <button
          className="flex lg:hidden flex-col gap-[2px] p-2 z-[60] shrink-0"
          aria-label="Menu"
        ...
        <div className={`absolute top-full left-0 w-full bg-[#FAFAF7]/95 backdrop-blur-md overflow-hidden transition-all duration-300 ease-in-out lg:hidden ${isOpen ? 'max-h-[400px] opacity-100 shadow-[0_10px_30px_rgba(0,0,0,0.05)] border-b border-[#E0DCD2]/50' : 'max-h-0 opacity-0'}`}>
          <div className="flex flex-col items-center gap-6 pt-6 pb-8 border-t border-[#E0DCD2]/30">
            ...
            <a href="#fractional-cmo" onClick={() => setIsOpen(false)} className="text-xl font-serif text-[#1A2F25]">Fractional CMO</a>
            <a href="#work" onClick={() => setIsOpen(false)} className="text-xl font-serif text-[#1A2F25]">Work</a>
            <a href="#who-i-work-with" onClick={() => setIsOpen(false)} className="text-xl font-serif text-[#1A2F25]">Who I work with</a>

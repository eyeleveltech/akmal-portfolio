        ...
        <div className="max-w-[1360px] mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_auto] gap-10 sm:gap-16 items-start mb-12">
            <div>
              <img
                src={white_logo}
                className="block w-[140px] sm:w-auto h-auto sm:h-[2.8rem] object-contain mb-3"
                alt="Akmal Rahman"
              />
              <p className="text-sm text-white/40">
                Founder, EyeLevel Growth Studio. Marketing practitioner,
                Chennai.
              </p>
            </div>
            <div className="flex flex-wrap gap-8 sm:gap-[clamp(2rem,5vw,5rem)]">
              <div className="flex flex-col gap-2.5">
                <p className="text-xs font-semibold tracking-[0.12em] uppercase text-white/30 mb-3.5">
                  Connect
                </p>
                <ul className="flex flex-col gap-2.5">
                  <li>
                    <a
                      ...
                      href="https://www.linkedin.com/in/akmalbillekar/"
                      target="_blank"
                      rel="noopener"
                    >
                      LinkedIn ↗
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <ul className="flex flex-col gap-2.5">
                  <li>
                    <a
                      className="text-sm text-white/55 transition-colors duration-200 hover:text-white"
                      href="https://mail.google.com/mail/?view=cm&fs=1&to=akmal@eyelevelstudio.in"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      akmal@eyelevelstudio.in
                    </a>
                  </li>
                  <li>
                    <a
          ...
          <div className="border-t border-white/10 pt-6 flex flex-wrap justify-between items-center gap-4">
            <p className="text-xs text-white/25">
              &copy; 2026 Akmal Rahman. All rights reserved.
            </p>
            <p className="text-xs text-white/25">
              Built by{" "}
              <a

    ...
    <>
      <section className="w-full min-h-dvh overflow-hidden bg-[#F2EEE6] flex flex-col justify-center py-[clamp(5rem,10vh,8rem)] px-[clamp(1.5rem,5vw,4.5rem)]" id="work">
        <div className="max-w-[1360px] mx-auto w-full">
          <p className="text-xs font-semibold tracking-[0.15em] uppercase text-[#1C4A2E] inline-flex items-center gap-3 mb-7 before:content-[''] before:inline-block before:w-[22px] before:h-px before:bg-[#1C4A2E]">The engagement</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-[clamp(3rem,7vw,8rem)] items-center">
            <div>
              ...
              <p className="text-[clamp(1rem,1.15vw,1.125rem)] text-black/50 leading-[1.7] max-w-[480px] mb-8">
                I work with a small number of companies at a time — as a direct Fractional CMO or through EyeLevel Growth Studio as your agency. Either way: strategy and execution, not just advice.
              </p>
